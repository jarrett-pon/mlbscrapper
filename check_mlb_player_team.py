...
GET_PLAYERS = ("SELECT teams.id AS teams_id, players.mlb_id AS players_mlb_id"
                " FROM players"
...
# Current players need to be in list of tuples with (teams_id, players_mlb_id)
current_player_info = [(int(player[2]), int(player[0])) for player in current_player_info]
